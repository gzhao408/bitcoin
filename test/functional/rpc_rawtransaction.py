...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-25, 'max-fee-exceeded', self.nodes[2].sendrawtransaction, rawTxSigned['hex'], 0.00001000)
        ...
        assert_equal(testres['reject-reason'], 'max-fee-exceeded')
        # and sendrawtransaction should throw
        assert_raises_rpc_error(-25, 'max-fee-exceeded', self.nodes[2].sendrawtransaction, rawTxSigned['hex'])
        # and the following calls should both succeed
