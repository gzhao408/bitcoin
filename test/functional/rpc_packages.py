...
class RPCPackagesTest(BitcoinTestFramework):
    ...
    def test_independent(self):
        ...
        assert_equal(testres_bad, [{"txid": tx.rehash(), "allowed": False, "reject-reason": "missing-inputs"}])
    ...
    def test_conflicting(self):
        ...
        assert_equal(testres, [{"txid": tx2.rehash(), "allowed": False, "reject-reason": "conflict-in-package"}])
    ...
    def test_rbf(self):
        ...
        assert_equal(testres_rbf_conflicting, [{"txid": replacement_tx.rehash(), "allowed": False, "reject-reason": "conflict-in-package"}])
