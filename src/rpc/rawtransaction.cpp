                ...
                RPCResult{
                        ...
                        "It is possible for transactions to not be fully validated ('allowed' unset) if an earlier transaction failed.\n",
                    {
                        {RPCResult::Type::OBJ, "", "",
                        {
                            ...
                            {RPCResult::Type::BOOL, "allowed", "Whether this tx would be accepted to mempool and passes client specified maxfeerate. If not present, the tx was not fully validated due to a failure in another tx in the list."},
        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    ...
    // A package cannot possibly be valid if it has more transactions than the descendant count limit.
